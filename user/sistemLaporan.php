...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO laporan ( user_id, judul_laporan, nama_aplikasi, kantor_sar, nama_pelapor, media_pelaporan, waktu_pelaporan,
        nama_petugas, tanggal_pemutakhiran, deskripsi_permasalahan, gambar_deskripsi, solusi_permasalahan,
        gambar_solusi, tanggal_penyelesaian, status_laporan, durasi, jenis_permasalahan, unit_kerja) VALUES (
        '$user_id', '$judul_laporan', '$nama_aplikasi', '$kantor_sar', '$nama_pelapor', '$media_pelaporan',
        '$waktu_pelaporan', '$nama_petugas', '$tanggal_pemutakhiran', '$deskripsi_permasalahan', 
        '$gambar_deskripsi', '$solusi_permasalahan', '$gambar_solusi', '$tanggal_penyelesaian', 
        '$status_laporan', '$durasi', '$jenis_permasalahan', '$unit_kerja')";
